  ...
  <div class="container">
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-sm-6">
        <img src="http://order.studyingroom.net/img/oamkfi.png" alt="Oulun Ammattikorkeakoulu" />
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-md-offset-4 col-sm-6">
        <h4>Kirjaudu sisään ylläpitäjänä</h4>
      </div>
    </div>
    <form name="login" action="login.php" method="POST">
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Käyttäjätunnus</span>
      ...
      <div class="row">
        <div class="col-md-4 col-md-offset-4 col-sm-6">
          <div class="input-group">
            <span class="input-group-addon" id="basic-addon1">Salasana</span>
